...
checkpointDir = 'modelCheckpoints_10Epoch';
...
filename = strcat('Basic_Train_confusion_matrix_rate1',num2str(numEpochs),'.xlsx');
xlswrite(filename, train_conf_mat,1,'A1');

filename = strcat('Basic_Train_classification_matrix_rate1',num2str(numEpochs),'.xlsx');
...
filename = strcat('Basic_Validation_confusion_matrix_rate1',num2str(numEpochs),'.xlsx');
xlswrite(filename, val_conf_mat,1,'A1');

filename = strcat('Basic_Validation_classification_matrix_rate1',num2str(numEpochs),'.xlsx');
...
filename = strcat('Basic_Test_confusion_matrix_rate1',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_conf_mat,1,'A1');

filename = strcat('Basic_Test_classification_matrix_rate1',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_class_mat,1,'A1');

f=figure;
plotTrainingAccuracy_All(info1,numEpochs);
saveas(f,'Basic_10epoch_rate1.png');
...
filename = strcat('Basic_Train_confusion_matrix_rate2',num2str(numEpochs),'.xlsx');
xlswrite(filename, train_conf_mat,1,'A1');

filename = strcat('Basic_Train_classification_matrix_rate2',num2str(numEpochs),'.xlsx');
xlswrite(filename, train_class_mat,1,'A1');
...
filename = strcat('Basic_Validation_confusion_matrix_rate2',num2str(numEpochs),'.xlsx');
xlswrite(filename, val_conf_mat,1,'A1');

filename = strcat('Basic_Validation_classification_matrix_rate2',num2str(numEpochs),'.xlsx');
xlswrite(filename, val_class_mat,1,'A1');
...
filename = strcat('Basic_Test_confusion_matrix_rate2',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_conf_mat,1,'A1');

filename = strcat('Basic_Test_classification_matrix_rate2',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_class_mat,1,'A1');

f=figure;
plotTrainingAccuracy_All(info1,numEpochs);
saveas(f,'Basic_10epoch_rate2.png');
...
figure;
montage(I2);
title('First Convolutional Layer visualisation for basic net');