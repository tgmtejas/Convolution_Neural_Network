clc;
mkdir('data\wallpapers', 'test_alex')
...
for i = 1: szdim
    ...
    %subfolder = str{i};
    dirpath = strcat('data\wallpapers\Test\', str{i});
    mkdir('data\wallpapers\test_alex\', str{i})
    dirpath2 = strcat('data\wallpapers\test_alex\');
