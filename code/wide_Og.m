...
filename = strcat('Wd_Train_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, train_conf_mat,1,'A1');

filename = strcat('Wd_Train_classification_matrix_',num2str(numEpochs),'.xlsx');
...
filename = strcat('Wd_Validation_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, val_conf_mat,1,'A1');

filename = strcat('Wd_Validation_classification_',num2str(numEpochs),'.xlsx');
...
filename = strcat('Wd_Test_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_conf_mat,1,'A1');

filename = strcat('Wd_Test_classification_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_class_mat,1,'A1');

%%
f=figure;
plotTrainingAccuracy_All(info1,numEpochs);
saveas(f,'Wd_wide_10Epoc.png');
