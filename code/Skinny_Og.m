...
checkpointDir = 'modelCheckpoints_skinny_Aug_transferLearn';
...
filename = strcat('Train_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, train_conf_mat,1,'A1');

filename = strcat('Train_classification_matrix_',num2str(numEpochs),'.xlsx');
...
filename = strcat('Validation_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, val_conf_mat,1,'A1');

filename = strcat('Validation_classification_matrix_',num2str(numEpochs),'.xlsx');
...
filename = strcat('Test_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_conf_mat,1,'A1');

filename = strcat('Test_classification_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_class_mat,1,'A1');

f=figure;
plotTrainingAccuracy_All(info1,numEpochs);
saveas(f,'Skinny_10Epoc.png');
