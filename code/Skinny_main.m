...
checkpointDir = 'modelCheckpoints_skinny_Aug';
...
filename = strcat('Sk_Train_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, train_conf_mat,1,'A1');

filename = strcat('Sk_Train_classification_matrix_',num2str(numEpochs),'.xlsx');
...
filename = strcat('Sk_Validation_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, val_conf_mat,1,'A1');

filename = strcat('Sk_Validation_classification_matrix_',num2str(numEpochs),'.xlsx');
...
filename = strcat('Sk_Test_confusion_matrix_',num2str(numEpochs),'.xlsx');
xlswrite(filename, test_conf_mat,1,'A1');

filename = strcat('Sk_Test_classification_matrix_',num2str(numEpochs),'.xlsx');
